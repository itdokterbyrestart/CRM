	...
	<div class="card-body">
        <form wire:submit="store" class="my-1">
            <div class="row justify-content-between align-items-start mb-2">
                <div class="col-auto">
                    <a href="{{ route('quotestatus.index') }}" wire:loading.attr="disabled" type="button" class="btn btn-danger" tabindex="0">
                ...
                @else
                    <div class="col-auto">
                        <a class="btn btn-primary" href="{{ route('quotestatus.edit', $modelId) }}" tabindex="0">
                            Aanpassen
                        </a>
                    </div>
                @endif
