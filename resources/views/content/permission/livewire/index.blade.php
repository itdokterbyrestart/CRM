<div class="card">
    <div class="card-header">
        <h4 class="card-title"><a href="{{ route('permission.create') }}" class="btn btn-primary">+ Nieuwe permissie</a></h4>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a class="btn btn-primary" href="{{ route('permission.show', $permission->id) }}">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-secondary" href="{{ route('permission.edit', $permission->id) }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button class="btn btn-danger" wire:click="deleteConfirm('{{ $permission->id }}')">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="100%">
                                                <span class="font-weight-bold">Er zijn geen permissies gevonden</span>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>                                
