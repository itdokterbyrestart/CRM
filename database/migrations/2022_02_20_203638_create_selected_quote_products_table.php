...
class CreateSelectedQuoteProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('selected_quote_products', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('selected_quote_products');
    }
}
