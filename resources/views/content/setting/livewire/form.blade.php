	...
	<div class="card-body">  
        <form wire:submit="store" class="my-1">
            <div class="row justify-content-between align-items-start mb-2">
                <div class="col-auto">
                    <a href="{{ route('setting.index') }}" wire:loading.attr="disabled" type="button" class="btn btn-danger" tabindex="0">
                ...
                @else
                    <div class="col-auto">
                        <a class="btn btn-primary" href="{{ route('setting.edit', $modelId) }}" tabindex="0">
                            Aanpassen
                        </a>
                    </div>
                @endif
            ...
            <div class="mb-1">
                <label for="value" class="col-form-label col-form-label-md">Waarde</label>
                <textarea wire:model.blur="value" type="text" class="form-control form-control-md @error('value') is-invalid @enderror" id="value" required tabindex="0" @if ($edit === 0) disabled @endif></textarea>
                @error('value')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
