            ...
            @if ($show_party_fields == 1)
                ...
                <div class="form-row mb-1">
                    ...
                    <div class="col-12 col-md-4">
                        <label for="party_date" class="col-form-label col-form-label-md">Feest datum</label>
                        <input wire:model.blur="party_date" type="date" class="form-control form-control-md @error('party_date') is-invalid @enderror" id="party_date" tabindex="0" @if ($edit === 0) disabled @endif>
                        @error('party_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- start_time --}}
                    <div class="col-12 col-md-4">
                        <label for="start_time" class="col-form-label col-form-label-md">Starttijd</label>
                        <input wire:model.blur="start_time" type="time" class="form-control form-control-md @error('start_time') is-invalid @enderror" id="start_time" tabindex="0" @if ($edit === 0) disabled @endif>
                        @error('start_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- end_time --}}
                    <div class="col-12 col-md-4">
                        <label for="end_time" class="col-form-label col-form-label-md">Eindtijd</label>
                        <input wire:model.blur="end_time" type="time" class="form-control form-control-md @error('end_time') is-invalid @enderror" id="end_time" tabindex="0" @if ($edit === 0) disabled @endif>
                        @error('end_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- party_type --}}
                    <div class="col-12 col-md-4">
                        <label for="party_type" class="col-form-label col-form-label-md">Type feest</label>
                        <select wire:model.blur="party_type" class="form-control form-control-md @error('party_type') is-invalid @enderror" id="party_type" @if ($edit === 0) disabled @endif>
                            <option value="">Kies een type feest</option>
                    ...
                    {{-- location --}}
                    <div class="col-12 col-md-4">
                        <label for="location" class="col-form-label col-form-label-md">Feestlocatie</label>
                        <div wire:ignore>
                            <select name="location" class="form-control form-control-md @error('location') is-invalid @enderror" id="location">
                                <option></option>
                    ...
                    {{-- guest_amount --}}
                    <div class="col-12 col-md-4">
                        <label for="guest_amount" class="col-form-label col-form-label-md">Aantal gasten</label>
                        <input pattern="[0-9]*" wire:model.blur="guest_amount" type="number" step="1" class="form-control form-control-md @error('guest_amount') is-invalid @enderror" id="guest_amount" tabindex="0" @if ($edit === 0) disabled @endif>
                        @error('guest_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
