...
class Form extends Component
{
    ...
    {
        return [
            'name' => 'required|string|min:2|unique:invoice_statuses,name,' . $this->modelId,
    ...
    public function store()
    {
        ...
        if ($this->modelId) {
            $order = InvoiceStatus::find($this->modelId)->order;
        } else {
            $order = InvoiceStatus::max('order') + 1;
        }
    ...
    {
        return view('content.invoicestatus.livewire.form');
    }
}
